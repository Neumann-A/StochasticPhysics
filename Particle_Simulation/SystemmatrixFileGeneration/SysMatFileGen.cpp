...
std::visit(overload{
        ...
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Constant>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Constant>::type>(in_params,SimManSet);},
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Sinusoidal>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Sinusoidal>::type>(in_params,SimManSet);},
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Lissajous>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Lissajous>::type>(in_params,SimManSet);},
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Triangular>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Triangular>::type>(in_params,SimManSet);},
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Rectangular>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Rectangular>::type>(in_params,SimManSet);},
        [&in_params,&SimManSet](SettingsFileGen::field_enum_property_mapping<IField::Field_Sinc>::type&){
                    SettingsFileGen::SimFileGen<SettingsFileGen::field_enum_property_mapping<IField::Field_Sinc>::type>(in_params,SimManSet);}
},var);
        return 0;
}
