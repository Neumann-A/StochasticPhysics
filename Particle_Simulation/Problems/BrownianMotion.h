...
namespace Problems {
    ...
    private:
        ...
        StochasticMatrixType        m_DiffusionMatrix;
    ...
    public:
        ...
        explicit BrownianMotion(const Parameters& params) :
            m_DiffusionMatrix(buildDiffusionMatrix(params.GetDiffusionCoefficient())),
            m_boundary(params), m_params(params)
        {
