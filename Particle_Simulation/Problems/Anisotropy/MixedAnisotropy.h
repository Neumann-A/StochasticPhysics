#ifndef INC_MixedAnisotropy_H
#define INC_MixedAnisotropy_H
...
#include "Properties/Anisotropy/Mixed.hpp"
...
namespace Problems::Anisotropy
{
    ...
    class MixedAnisotropy : public GeneralAnisotropy<MixedAnisotropy<prec>>
    {
        using ThisClass = MixedAnisotropy<prec>;
    ...
    template<typename prec>
    struct AnisotropyTraits<MixedAnisotropy<prec>>
    {
        //Default Traits:
        using Precision = prec;
        using Anisotropy = MixedAnisotropy<Precision>;
        ...
        using input_parameter = ::Properties::Anisotropy::Mixed<prec>;
        ...
        static constexpr value_type value = value_type::Anisotropy_mixed;
    };
