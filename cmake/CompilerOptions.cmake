enable_language(CXX)
 ...
 if (MSVC AND NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
  ...
  if ( "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    # using Clang-Cl
	set(MY_RELEASE_OPTIONS "/W4;/Ox;/Oi;/Ot;/Oy;/fp:fast;/arch:AVX2;/bigobj;-fmacro-backtrace-limit=0;-fcolor-diagnostics;/std:c++latest")
	...
	set(MY_RELEASE_OPTIONS "/W4;/Ox;/Oi;/Ot;/Oy;/GL;/MP;/fp:fast;/arch:AVX;/bigobj;/std:c++latest")
	add_compile_options("$<$<CONFIG:DEBUG>:${MY_DEBUG_OPTIONS}>")
	add_compile_options("$<$<CONFIG:RELEASE>:${MY_RELEASE_OPTIONS}>")
