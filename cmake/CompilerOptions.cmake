enable_language(CXX)
 ...
 if (MSVC AND NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
  ...
  if ( "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    # using Clang-Cl
	set(MY_RELEASE_OPTIONS "/W4;/Ox;/Oi;/Ot;/Oy;/fp:fast;/arch:AVX;/bigobj")
...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" AND NOT MSVC)
  ...
  # using Clang
  message(STATUS "Clang compiler switches not set!")
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
  # using GCC
    add_compile_options("-std=c++11")
	add_compile_options("-stdlib=libc++")
	#add_compile_options("-lc++abi")
    message(STATUS "GCC compiler switches not set!")
